...
An end-to-end real-time media engine for an AI agent framework powered by Go, integrating media processing, Python tooling, and a complete frontend-backend stack.
---
## 🔧 Project Overview
